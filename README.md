...
Allows you to find the constituents of the SP500 at a specific date. This can be used to eliminate survivorship bias in backtesting. This also works for any universe with a column for "date" and a column for "tickers". The code will let you define the names for each column if they are named differently. Note that the given SP500 constituents history data only goes as far back as 1996-01-02 and as recent as 2025-11-11
